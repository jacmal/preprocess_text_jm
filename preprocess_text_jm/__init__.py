from preprocess_text_jm import utils
import string
...
def remove_multi_spaces(x):
	return utils._remove_multi_spaces(x)
...
def remove_rare_words(x, freq, n=5):
	return utils._remove_rare_words(x, freq, n=5)

def spelling_correction(x):
	return utils._spelling_correction(x)

def all_chars_counter(raw_text, char_list):
	return utils._all_chars_counter(raw_text, char_list=letters)

def letter_prob(raw_text, char_list=letters):
	return utils._letter_prob(raw_text, char_list=letters)

def text_entropy(raw_text, char_list=letters):
	return utils._text_entropy(raw_text, char_list=letters)

def chars_sequence_counter(raw_text, chars_list=letters):
	return utils._chars_sequence_counter(raw_text, chars_list=letters)

def some_func():
	return utils._some_func()